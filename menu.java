...
class menu extends JFrame {
	...
	public menu () {
		...
		areaFuente= new Font("Arial", Font.PLAIN, tamanio);
	...
	public void menus () {
		...
		JMenuItem fuen= new JMenuItem("Tama�o de fuente",new ImageIcon("images/hoja_2.gif"));
	...
	public void barra () {
		...
		tFuente.setToolTipText("Tama�o de fuente");
				...
				public void itemStateChanged(ItemEvent e) {
					...
					switch (elegido) {
						...
						case 5:
							...
							break;
						case 6:
							tamanio=Integer.parseInt(JOptionPane.showInputDialog("Digite el tama�o de la fuente"));
							areaFuente= new Font("Arial", Font.PLAIN, tamanio);
							areaTexto.setFont(areaFuente);
							break;
					}
	...
	public void tamanio_f () {
		tamanio=Integer.parseInt(JOptionPane.showInputDialog("Digite el tamaño de la fuente"));
		areaFuente= new Font("Arial", Font.PLAIN, tamanio);
		areaTexto.setFont(areaFuente);
	}

	public void acerca () {
		JOptionPane.showMessageDialog(null,"Editor de textos\nDesarrollado por:  Jhon Jairo Roldan\nIngenieria de sistemas\nUniversidad Distrital Francisco Jose de Caldas\nCodigo:  20022020184\nE-mail:  jjroldanc@gicoge.udistrital.edu.co");
	}
